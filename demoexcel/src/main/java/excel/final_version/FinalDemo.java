...
public class FinalDemo {
    //在这里统一设置一下sql语句，便于修改
    final static String INSERT_INTO_MEMBERS = "insert into members (name,sex,age) values (?,?,?);";
    final static String INSERT_INTO_BOOKS = "insert into books (id,name,user) values (?,?,?);";
    final static String SELECT_FORM_MEMBERS = "select * from members; ";
    final static String SELECT_FROM_BOOKS = "select * from books";

    public static void main(String[] args) {
        List<String> head = Arrays.asList("姓名","性别","年龄");
        exportExcel("C://Users/yuanyiwen/Desktop/demo2.xlsx");
//        importExcel("C://Users/yuanyiwen/Desktop/demo2.xlsx",head);
    }
     ...
     * @param head 表头
     */
    public static void importExcel(String filePath,List<String> head){
        //创建工作簿
     ...
     * @param sql 动态注入查询语句
     */
    public static List<String> connMysql(List<String> head, String sql, String sqlType){
        //定义MYSQL连接对象
        ...
        try {
            ...
            //连接本地MYSQL
            connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/demoexcel" +
